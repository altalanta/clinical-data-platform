with labs as (
    select
        ...
        high_flag,
        low_flag
    from "clinical"."main_intermediate"."int_lab_latest"
),
lab_pivot as (
    select
        patient_id,
...
features as (
    ...
    from "clinical"."main_marts"."fct_cohort" as cohort
    left join "clinical"."main_intermediate"."int_dx_flags" as dx
        on cohort.patient_id = dx.patient_id
    left join "clinical"."main_intermediate"."int_proc_flags" as proc
